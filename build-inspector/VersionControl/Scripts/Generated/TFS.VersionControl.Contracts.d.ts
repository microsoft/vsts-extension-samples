...
export interface GitPushRef {
    ...
    pushedBy: WebApi_Contracts.IdentityRef;
    pushId: number;
    url: string;
}
...
export interface GitRef {
    _links: any;
    isLockedBy: WebApi_Contracts.IdentityRef;
    name: string;
    objectId: string;
    url: string;
}
...
export interface IdentityRefWithVote extends WebApi_Contracts.IdentityRef {
    isRequired: boolean;
    reviewerUrl: string;
    vote: number;
...
export interface TfvcBranchRef extends TfvcShallowBranchRef {
    ...
    description: string;
    isDeleted: boolean;
    owner: WebApi_Contracts.IdentityRef;
    url: string;
}
...
export interface TfvcChangesetRef {
    _links: any;
    author: WebApi_Contracts.IdentityRef;
    changesetId: number;
    checkedInBy: WebApi_Contracts.IdentityRef;
    comment: string;
    commentTruncated: boolean;
    createdDate: Date;
    url: string;
